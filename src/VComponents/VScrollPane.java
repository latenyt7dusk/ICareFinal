...
public class VScrollPane extends JScrollPane {
    ...
    public VScrollPane(Color r){
        
        
        setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
        setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        getVerticalScrollBar().setUI(new VScrollBarUI().createVerticalScrollBar(r, ScrollTrackColor, ScrollThumbNormalColor, ScrollThumbHoverColor, VScrollStyle.Value()));//VScrollBarUI.SIMPLE_LINE
        getVerticalScrollBar().setPreferredSize(new Dimension(ScrollWidth, 0));
        getVerticalScrollBar().setOpaque(false);
