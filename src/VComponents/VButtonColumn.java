...
/**
 * The VButtonColumn class provides a renderer and an editor that looks like a
 ...
 *
 */
public class VButtonColumn extends AbstractCellEditor
    ...
    // VButtonColumn buttonColumn = new VButtonColumn(table, delete, 2);
     ...
     */
    public VButtonColumn(JTable table, Action action, int column) {
        this.table = table;
        this.action = action;
